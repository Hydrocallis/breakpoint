...
class BP_PT_bp(bpy.types.Panel):
    bl_label = "BreakPoint"
    bl_space_type = "TEXT_EDITOR"
    bl_region_type = "UI"
    bl_category = "BreakPoint"
    bl_context = "WINDOW"
    ...
    def draw(self, context):
        ...
        if scn.gsg1_display_help:
            ...
            #box.label(text=" 'BreakPoint' Instructions:", icon=pic)
    ...
    def bp(dictionary = {}, pause = True, prnt = True):
        ...
        text = "Breakpoint #" + str(BP_PT_bp.breakpoints) + " >>  Line: " + str(s[1]) + "  In: '" + str(s[2]) + "'  File: '" + scrpt + "'"
...
class BP_OT_ClearLog(bpy.types.Operator):
